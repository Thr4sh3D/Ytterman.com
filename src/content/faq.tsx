...
export const faqItems: FAQItem[] = [
  // Kontrollansvarig
  {
    ...
    answer: "En kontrollansvarig ansvarar för teknisk kontroll under byggprocessen, upprättar kontrollplan, deltar i tekniskt samråd och besiktningar, lämnar ett skriftligt utlåtande med underlag inför slutbesked, och ser till att byggnadsnämnden kan bevilja slutbesked enligt Plan- och bygglagen (PBL).",
  ...
  },
  {
    ...
    answer: "Priset inkluderar granskning av ritningar och handlingar, upprättande av kontrollplan, tekniska kontroller på bygget enligt kontrollplanen, löpande dokumentation, samordning med byggledning och projektörer samt KA:s utlåtande med underlag inför slutbesked. Resor inom Västernorrland ingår utan extra kostnad.",
  ...
  },
  {
    ...
    answer: "Att bygga utan kontrollansvarig när det krävs är lagbrott som kan leda till byggförbud, byggsanktionsavgift upp till flera hundra tusen kronor och krav på rivning i värsta fall. Dessutom kan du inte få slutbesked från byggnadsnämnden, vilket gör fastigheten juridiskt otillåten att använda eller sälja.",

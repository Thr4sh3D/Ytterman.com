    ...
    >
      <div className="prose prose-stone max-w-none">
        ...
        <p className="text-lg text-stone-700 mb-6">
          ...
          kritiska kontrollpunkter tidigt kan du förebygga problem och säkerställa att projektet 
        ...
        <p className="mb-6">
          Framgångsrik kvalitetskontroll kräver nära samarbete med alla inblandade entreprenörer. 

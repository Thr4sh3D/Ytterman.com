                ...
                <div className="bg-white rounded-xl shadow-lg border-2 border-primary/20 p-8 mb-6">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                    <div>
                      ...
                      <p className="text-stone-600">Teknisk kontroll och underlag för slutbesked för ditt byggprojekt</p>
                    </div>
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
                    ...
                    <ul className="text-sm text-blue-800 space-y-1">
                      ...
                      <li>✓ Slutbesiktning och KA:s utlåtande inför slutbesked</li>
